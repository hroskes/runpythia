...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:ggH2bplus_125_LHE_fixscale.root'),
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('Configuration/GenProduction/python/HIG-RunIIWinter15GS-00123-fragment.py nevts:53'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:ggH2bplus_125_GEN_fixscale_time.root'),
